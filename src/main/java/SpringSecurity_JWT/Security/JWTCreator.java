package SpringSecurity_JWT.Security;
...
public class JWTCreator {
    ...
    public static String create(String prefix, String key, JWT_Object jwtObject) {
    ...
    public static JWT_Object create(String token, String prefix, String key)
            throws ExpiredJwtException, UnsupportedJwtException, MalformedJwtException, SignatureException {
        JWT_Object object = new JWT_Object();
